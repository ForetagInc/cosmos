...
const badgeVariants = tv({
	base: 'inline-flex items-center rounded-md border px-2 py-0.5 font-medium text-[11px] uppercase tracking-wide transition-[color,background-color,border-color,box-shadow] [background:var(--badge-bg)] [border-color:var(--badge-border)] [color:var(--badge-fg)] shadow-[var(--badge-shadow)] focus:outline-none focus-visible:shadow-[var(--borders-interactive-with-active)]',
	variants: {
		variant: {
			default:
